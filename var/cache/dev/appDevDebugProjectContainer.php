...
class appDevDebugProjectContainer extends Container
{
    ...
    {
        $this->services['cache.app'] = $instance = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('CC7xq-6ZeR', '', (__DIR__.'/pools'));
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('QMEVH8IkWY', '', 'j6DC5elDUi9G9ydixuTjeA', (__DIR__.'/pools'), $this->get('monolog.logger.cache', ContainerInterface::NULL_ON_INVALID_REFERENCE));
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('bMR+QWKmGv', '', 'j6DC5elDUi9G9ydixuTjeA', (__DIR__.'/pools'), $a));
        $b->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('0Z94RDa3Cq', '', 'j6DC5elDUi9G9ydixuTjeA', (__DIR__.'/pools'), $a));
    ...
    protected function getDoctrine_Dbal_DefaultConnectionService()
    {
        ...
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('driver' => 'pdo_sqlite', 'host' => '127.0.0.1', 'port' => NULL, 'dbname' => 'symfony', 'user' => 'root', 'password' => NULL, 'charset' => 'UTF8', 'path' => ($this->targetDirs[3].'\\app/data'), 'driverOptions' => array(), 'defaultTableOptions' => array()), $b, $c, array());
    }
    ...
    protected function getDoctrineCache_Providers_Doctrine_Orm_DefaultMetadataCacheService()
    {
        ...
        $instance->setNamespace('sf2orm_default_8745cbf7e8485d6f73ac9b3ff5983abbdb6bee175b9977b1a8d43883c7eea68a');
    ...
    public function getFosRest_SerializerService($lazyLoad = true)
    {
        if ($lazyLoad) {
            ...
            return $this->services['fos_rest.serializer'] = FOSRestBundleSerializerSymfonySerializerAdapter_000000003b2c6d64000000000b725a98cbb6c6fb368d6abd31f441c05725cf9d::staticProxyConstructor(
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('3aa55021634e5b2762ff3e6ad17dfdf645bd58c6');
    }
    ...
    {
        $this->services['security.authentication.manager'] = $instance = new \Symfony\Component\Security\Core\Authentication\AuthenticationProviderManager(array(0 => new \Symfony\Component\Security\Core\Authentication\Provider\AnonymousAuthenticationProvider('577e53b2e46167.77490748')), true);
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'secret' => '3aa55021634e5b2762ff3e6ad17dfdf645bd58c6',
            'locale' => 'en',
            'fragment.renderer.hinclude.global_template' => NULL,
            'fragment.path' => '/_fragment',
            'kernel.secret' => '3aa55021634e5b2762ff3e6ad17dfdf645bd58c6',
...
class FOSRestBundleSerializerSymfonySerializerAdapter_000000003b2c6d64000000000b725a98cbb6c6fb368d6abd31f441c05725cf9d extends \FOS\RestBundle\Serializer\SymfonySerializerAdapter implements \ProxyManager\Proxy\VirtualProxyInterface
{

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $valueHolder577e53b326713507351312 = null;

    /**
     * @var \Closure|null initializer responsible for generating the wrapped object
     */
    private $initializer577e53b326713283958070 = null;

    /**
     * @var bool[] map of public properties of the parent class
     */
    private static $publicProperties577e53b326713854108645 = array(
    ...
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, 'serialize', array('data' => $data, 'format' => $format, 'context' => $context), $this->initializer577e53b326713283958070);

        return $this->valueHolder577e53b326713507351312->serialize($data, $format, $context);
    }
    ...
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, 'deserialize', array('data' => $data, 'type' => $type, 'format' => $format, 'context' => $context), $this->initializer577e53b326713283958070);

        return $this->valueHolder577e53b326713507351312->deserialize($data, $type, $format, $context);
    }
    ...
    public static function staticProxyConstructor($initializer)
    {
        ...
        $instance->initializer577e53b326713283958070 = $initializer;
    ...
    public function __construct(\Symfony\Component\Serializer\SerializerInterface $serializer)
    {
        ...
        if (! $this->valueHolder577e53b326713507351312) {
            $reflection = $reflection ?: new \ReflectionClass('FOS\\RestBundle\\Serializer\\SymfonySerializerAdapter');
            $this->valueHolder577e53b326713507351312 = $reflection->newInstanceWithoutConstructor();
        \Closure::bind(function (\FOS\RestBundle\Serializer\SymfonySerializerAdapter $instance) {
            unset($instance->serializer);
        ...
        $this->valueHolder577e53b326713507351312->__construct($serializer);
    }
    ...
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, '__get', array('name' => $name), $this->initializer577e53b326713283958070);

        if (isset(self::$publicProperties577e53b326713854108645[$name])) {
            return $this->valueHolder577e53b326713507351312->$name;
        }

        $realInstanceReflection = new \ReflectionClass(get_parent_class($this));

        if (! $realInstanceReflection->hasProperty($name)) {
            $targetObject = $this->valueHolder577e53b326713507351312;
    ...
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, '__set', array('name' => $name, 'value' => $value), $this->initializer577e53b326713283958070);
    ...
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, '__isset', array('name' => $name), $this->initializer577e53b326713283958070);
    ...
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, '__unset', array('name' => $name), $this->initializer577e53b326713283958070);
    ...
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, '__clone', array(), $this->initializer577e53b326713283958070);

        $this->valueHolder577e53b326713507351312 = clone $this->valueHolder577e53b326713507351312;
    }

    public function __sleep()
    {
        $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, '__sleep', array(), $this->initializer577e53b326713283958070);

        return array('valueHolder577e53b326713507351312');
    }
    ...
    {
        $this->initializer577e53b326713283958070 = $initializer;
    }
    ...
    {
        return $this->initializer577e53b326713283958070;
    }
    ...
    {
        return $this->initializer577e53b326713283958070 && $this->initializer577e53b326713283958070->__invoke($this->valueHolder577e53b326713507351312, $this, 'initializeProxy', array(), $this->initializer577e53b326713283958070);
    }
    ...
    {
        return null !== $this->valueHolder577e53b326713507351312;
    }
    ...
    {
        return $this->valueHolder577e53b326713507351312;
    }
